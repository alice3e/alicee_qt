...
constexpr auto qt_meta_stringdata_CLASSlogin_formENDCLASS = QtMocHelpers::stringData(
    "login_form",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSlogin_formENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject login_form::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSlogin_formENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSlogin_formENDCLASS,
    qt_static_metacall,
    nullptr,
...
void *login_form::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSlogin_formENDCLASS.stringdata0))
